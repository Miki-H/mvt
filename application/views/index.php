...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../../assets/css/home/style.css">
...
<body>
    ...
    try
    {
        $bdd = new PDO("mysql:host=localhost;dbname=gestion_staock", 'root', '');
    }
    catch (Exception $e)
    {
    ...
    <section>
        ...
        <div class="section1">
            ...
            <div class="navigation">
                <img src="../../assets/images/toogle.png" class="toogle">
        ...
        <div class="section2">
                ...
                if(isset($_SESSION['id']))
                {
                    ...
                    echo '<span class="no-tel1"><img src="../../assets/images/appel.png" class="icon-appel">+261 32 98 681 22</span>';
                ...
                else
                {
                    ...
                    echo '<span class="no-tel"><img src="../../assets/images/appel.png" class="icon-appel">+261 32 98 681 22</span>';
                }
                ?>
            ...
            <div class="slider">
                <div class="slides">
                    <div class="slide">
                        <div class="slide1">
                            <img src="../../assets/images/shaker.png" class="img1" />
                        </div>
                        <div class="slide1">
                            <img src="../../assets/images/juggernaut.jpg" class="img2" />
                        </div>
                        <div class="slide1">
                            <img src="../../assets/images/grx.jpg" class="img3" />
                        </div>
                    </div>
                    <div class="constant">
